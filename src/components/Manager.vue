    ...
    <table style="width: 75%">
      ...
      <tbody>
        <tr>
          ...
          <td style="text-align: center">Malcolm Lockyer</td>
          <td style="text-align: center">21/03/1961</td>
        ...
        <tr>
          ...
          <td style="text-align: center">11/02/1990</td>
...
<style>
/* Center text in the entire table */
table {
  width: 100%;
}
...
/* Optional: Add some spacing and styling for buttons */
button {
  margin: 0 5px;
  padding: 5px 10px;
  border: none;
